defmodule SamsonEnMarieWeb.UserControllerTest do
  use SamsonEnMarieWeb.ConnCase

  alias SamsonEnMarie.UserContext

  @create_attrs %{achternaam: "some achternaam", email: "some email", hashed_password: "some hashed_password", huisnr: "some huisnr", land: "some land", postcode: "some postcode", role: "some role", stad: "some stad", straat: "some straat", voornaam: "some voornaam"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated achternaam"
    end
